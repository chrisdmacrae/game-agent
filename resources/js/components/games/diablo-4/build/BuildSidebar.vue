...
import { D4_ACCENT } from '@/components/games/diablo-4/build';
import type { SimilarBuild } from '@/components/games/diablo-4/types';
...
<template>
    <div class="flex w-full flex-col gap-4 lg:w-[280px] lg:shrink-0">
        <Card>
            ...
            <CodeBlock
                class="mt-3"
                :code="`byb://${gameSlug}/build/${buildId}`"
                filename="mcp resource"
            />
            <p class="mt-3 text-[13px] [text-wrap:pretty] text-[var(--fg-3)]">
                Numbers are reported by the publisher, not simulated by us.
                Season rotation moves them fast — check the patch badge.
            </p>
        </Card>
